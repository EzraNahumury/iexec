            ...
            <div className="relative max-w-5xl mx-auto px-6 py-12 md:py-16 space-y-10">
                ...
                <div className="grid md:grid-cols-2 gap-5">
                    ...
                    >
                        ...
                        {decryptError && (
                            <div className="mt-3 rounded-xl border border-red-400/30 bg-red-500/10 p-3 space-y-2.5">
                                <p className="text-xs text-red-100 leading-relaxed">{decryptError}</p>
                                {authExpired && (
                                    <div className="grid grid-cols-2 gap-2">
                                        <button
                                            onClick={onReconnect}
                                            className="rounded-full bg-white hover:bg-zinc-100 text-zinc-900 px-2 py-2 text-[10px] font-bold tracking-[0.14em] uppercase transition-colors inline-flex items-center justify-center gap-1.5"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-white px-2 py-2 text-[10px] font-bold tracking-[0.14em] uppercase transition-colors inline-flex items-center justify-center gap-1.5"
                                        >
                                            <RefreshCw className="size-3" />
                                            Reload page
                                        </button>
